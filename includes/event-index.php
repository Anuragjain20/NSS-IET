...
<div class="container-fluid background">
  <div class="row my-5">
    ...
    <div class= "background">
      ...
      <div class="middle">
        <a href="events.php#celebration"><div class="text">CELEBRATIONS</div></a>
      </div>
    </div>
</div>
    <!-- Health-->
    ...
    <div class= "background">
      ...
      <div class="middle">
        <a href="events.php#health"><div class="text">HEALTH</div></a>
      </div>
    </div>
</div>
    <!-- Awareness-->
    ...
    <div class= "background">
      ...
      <div class="middle">
        <a href="events.php#awareness"><div class="text">AWARENESS PROGRAMS</div></a>
      </div>
    </div>
  </div>
</div>
