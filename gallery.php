  ...
  <?php  function display_activity($activity_type, $color)
	{
		...
		foreach ($details as $detail) {
			...
			echo '<div class="col-sm-8 col-md-4 col-lg-4 pl-4 pr-4 my-5 mt-4 mx-auto " data-aos="zoom-in" data-aos-duration="2000">
					<div class="card ">
					<img src="' . $detail["folder"] . scandir($detail["folder"])[2] . '" alt="Avatar" class="image-fluid" style="width:100%">
	...
	<section class="about-section spad pt-0">
		<div class="container">
			...
			<h5 class="text-center my-3 py-2">Headings-1</h5>
			
			<hr>
			<div class="row">
				<?php display_activity("heading1", "primary"); ?>
			</div>


			<h5 class="text-center my-3  py-2">Headings-2</h5>
		
			<hr>
			<div class="row">
				<?php display_activity("heading2", "danger"); ?>
			</div>

			<h5 class="text-center my-3  py-2 " >Headings-3</h5>

			<hr>
			<div class="row">
				<?php display_activity("heading3", "success"); ?>
			</div>
