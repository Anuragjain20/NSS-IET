...
<body>
  ...
  <div class="container-fluid my-2 mt-4 py-2" id="celebration">
    ...
    <section class="description">
      ...
      <h1><span class="act-head">Guru Purnima</span></h1>
  ...
  <div class="blog-card alt my-5">
    ...
    <section class="description">
      ...
      <h1><span class="act-head">Photo Walk</span></h1>
 ...
 <!--     <p class="read-more">
  ...
  <div class="blog-card  my-5">
    ...
    <section class="description">
      ...
      <h1><span class="act-head">NSS Day</span></h1>
  ...
  <div class="blog-card alt my-5">
    ...
    <section class="description">
      <!-- <h1>Heading</h1>-->
      <h1><span class="act-head">Gandhi Jayanti</span></h1>
...
<div class="container-fluid my-2 py-2" id="health" style="background-color: #f8f8ff;">
  ...
  <div class="blog-card alt my-5">
    ...
    <section class="description">
      <h1><span class="act-head">Blood Donation camp</span></h1>
  ...
  <div class="blog-card  my-5">
    ...
    <section class="description">
      <h1><span class="act-head">Health Check-up Camp</span></h1>
  ...
  <div class="blog-card alt  my-5">
    ...
    <section class="description">
      <h1><span class="act-head">International Yoga Day</span></h1>
...
<div class="container-fluid my-2 py-2"  id="awareness">
  ...
  <div class="blog-card  my-5">
    ...
    <section class="description">
      <h1><span class="act-head">World Population Day</span></h1>
  ...
  <div class="blog-card alt my-5">
    ...
    <section class="description">
      <h1><span class="act-head">National Youth Week</span></h1>
  ...
  <div class="blog-card  my-5">
    ...
    <section class="description">
      <h1><span class="act-head">World AIDS Day</span></h1>
