...
<body>
     ...
     <div class="container-fluid my-5">
       ...
       <div class="row mx-auto my-5">
         <div class=" col-md-6 col-12  my-5 mx-auto">
          <div class="card px-1 contact-card mx-auto">
            <img src="images/contact-us/ssk.jpg"  class="cont-img img-fluid mx-auto " alt="name" >
         ...
         <div class=" col-md-6 col-12  my-5 mx-auto">
          <div class="card px-1 contact-card mx-auto">
            <img src="images/contact-us/suwarna.jpg"  class="cont-img img-fluid mx-auto " alt="name" >
            <div class="cont-text text-center py-3">
