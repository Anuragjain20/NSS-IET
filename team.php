        ...
        <div class=" col-12 col-sm-8 col-md-7 col-lg-5 mx-auto my-3">
            ...
            <div class=" col-12 col-sm-8 col-md-7 col-lg-5 mx-auto my-3">
                <div class="card mx-auto text-center">
                    ...
                    <img src="images/developer/SAKSHI.jpg" alt="Ankita_Giri" class="img-s mt-3 img-fluid">
                    <div class="card-body">
                        <h5 class="card-title">Sakshi Shastri</h5>
                        <h6 class="card-text">Head-Girl
                        </h6>
                        <i class="fab fa-whatsapp"></i><span class="card-text"><a href ="https://wa.me/9516283013" target="_blank"> : 7239923732</a></span><br>
                        <i class="fas fa-envelope"></i><span><a href="mailto:iamankitagiri9@gmail.com" target ="_blank"> : sakshishastri076@gmail.com</a><span>
    ...
    <div class="container">
        ...
        <div class="card-deck">
            <div class="card bg-light">
                ...
                <div class="card-body">
                    <div class="cardcontent"><b>200+ </b></div>
                    <div class="cardcontent">Volunteers</div>
                </div>
            </div>
            <div class=" card bg-light">
                <img src="images/Team/graph icon.png" alt="image2" class=" card-img-i">
                <div class="card-body">
                    <div class="cardcontent"><b>1300+ </b></div>
                    <div class="cardcontent">Facebook Followers</div>
                </div>
            </div>
            <div class="card bg-light">
                <img src="images/Team/events icon.png" alt="image2" class=" card-img-i">
                <div class="card-body">
                    <div class="cardcontent"><b>100+ </b></div>
                    <div class="cardcontent">Events</div>
                </div>
            </div>
